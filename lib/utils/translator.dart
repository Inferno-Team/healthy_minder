...
class Translator extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'ar_SY': {
          ...
          Keys.hello.name: ' مرحبا',
          Keys.noEventForToday.name: ' لا يوجد احداث لليوم ',
          Keys.noEventForTimeline.name: ' هذا مخطط التدريب لا يحتوي على احداث بعد',
          ...
          Keys.yourProgress.name: 'الحدث التالي',
          Keys.todayEvents.name:"أحداث اليوم",
          Keys.next.name: ' التالي',
          Keys.firstName.name: ' الاسم الاول',
          Keys.userName.name: ' اسم المستخدم',
          ...
          Keys.chat.name: 'محادثة',
          Keys.publicChat.name: ' محداثة عامة ',
          Keys.myProgress.name: ' سجل تقدمي',
          ...
          Keys.selectYourPlan.name: 'اختيار الخطة',
          Keys.completeAccount.name: 'أكمال الحساب',
          Keys.selectPlanTitle.name: 'قبل ان نبدأ يجب ان تختار الخطة المناسبة لك',
          ...
          Keys.timelineName.name: 'اسم مخطط الزمن',
          Keys.timelineEvents.name: 'احداث مخطط التدريب',
          Keys.settings.name: 'إعدادات',
          Keys.name.name: ' اسم ',
          Keys.eventCounts.name: ' عدد الاحداث ',
        },
        'en_US': {
          Keys.newKey.name:"New Key",
          Keys.password.name: 'Password ',
          Keys.hello.name: 'Hello ',
          Keys.noEventForToday.name: 'No Event For Today. ',
          ...
          Keys.yourProgress.name: 'Your Next Event',
          Keys.todayEvents.name:"Today's Events",
          Keys.next.name: 'Next ',
          Keys.firstName.name: 'First Name',
          Keys.userName.name: 'User Name',
          ...
          Keys.chat.name: 'Chat ',
          Keys.publicChat.name: 'Public Chat ',
          Keys.myProgress.name : "My Progress",
          ...
          Keys.content.name:
              'The payment process start when you scan QR from website via SYERIATEL\'s cash app QR code scanner and pay, after that a SMS message will be sent to you contain process code,copy it and click on the button and paste it in the dialog',
          ...
          Keys.completeAccount.name: 'Complete Account',
          Keys.selectYourPlan.name: 'Plan Selection',
          Keys.selectPlanTitle.name: 'Before start you need to select you plan',
          Keys.english.name: 'English ',
          Keys.arabic.name: 'Arabic ',
          Keys.dark.name: 'Dark ',
          Keys.light.name: 'Light ',
          Keys.timeline.name: 'Timeline',
          Keys.timelineName.name: 'Timeline Name',
          Keys.noEventForTimeline.name: 'Timeline Don\'t have events yet.',
          Keys.timelineEvents.name: 'Timeline\'s Event',
          Keys.settings.name: 'Settings',
          Keys.name.name: ' Name',
          Keys.eventCounts.name: 'Events Count',
        },
      };
}
